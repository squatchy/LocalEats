...
namespace LocalEats.Data
{
	public interface ILERepository
	{
		...
		Task<List<RestaurantInfo>> GetRestaurantListNearBy(FilterOptions filterOptions, double? lat = null, double? lon = null, string orCityId = null, int givenSize = 25, int skipping = 0);
